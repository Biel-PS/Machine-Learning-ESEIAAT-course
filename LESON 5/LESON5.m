...
scatter(data.x(data.y(:,1), 2), data.x(data.y(:,1), 3), 50, 'g', 'DisplayName', 'data1');
scatter(data.x(data.y(:,2), 2), data.x(data.y(:,2), 3), 50, 'r', 'DisplayName', 'data2');
scatter(data.x(data.y(:,3), 2), data.x(data.y(:,3), 3), 50, 'y', 'DisplayName', 'data3');
